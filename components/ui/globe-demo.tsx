...
export default function GlobeDemo() {
  ...
  const sampleArcs = [
    ...
    { order: 5, startLat: -22.9068, startLng: -43.1729, endLat: 28.6139, endLng: 77.209, arcAlt: 0.7, color: colors[1] },
  ];
      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          ...
          <p className="text-center text-base md:text-lg font-normal text-neutral-300 max-w-md mt-2 mx-auto">
            Our alumni are connected across the world — from New Delhi to New York,
            Sydney to São Paulo. This interactive globe shows how the Directorate of
            Alumni Affairs bridges generations and geographies.
          </p>
        </motion.div>
